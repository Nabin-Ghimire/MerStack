...
// }
// asyncfunRead();
const func1=()=>Promise.resolve("Resolved value 1");
const func2=()=>Promise.reject("Rejected value 2");
const func3=()=>Promise.resolve("Resolved value 3");
const result=Promise.allSettled([func1(),func2(),func3()])
all
